CUDA_VISIBLE_DEVICES=3 python ../scripts/finetune.py \
    ...
    --batch_size 128 \
    --lr 7e-5 \
    --save_name clip_action_encoder_only \
...
CUDA_VISIBLE_DEVICES=3 python ../scripts/finetune.py \
    ...
    --batch_size 128 \
    --lr 7e-5 \
    --save_name clip_action_encoder_only_augmented_dataset \
    --dataset_path /home/xilun/LIBERO/libero/datasets \
    --dataset_folders libero_spatial \
...
CUDA_VISIBLE_DEVICES=3 python ../scripts/finetune.py \
    ...
    --batch_size 128 \
    --lr 7e-5 \
    --save_name clip_action_encoder_only_positive_only_augmented_dataset \
    --dataset_path /home/xilun/LIBERO/libero/datasets \
    --dataset_folders libero_spatial \
