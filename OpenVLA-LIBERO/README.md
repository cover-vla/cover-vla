...
Now we add octo related packages: 
```bash
cd octo 
pip install -e .
pip install -r requirements.txt 
...
# If you have some errors with cuda, please install torch again
pip3 install torch torchvision torchaudio # for Cuda 12.2 
pip install transforms3d
pip install openai
pip install scikit-learn # this is needed for plot_statistics
```
