...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def predict_action(
        ...
        generated_output = self.generate(input_ids, max_new_tokens=self.get_action_dim(unnorm_key), **kwargs)
        generated_ids = generated_output["sequences"]
        generated_scores = generated_output["scores"]
        ...
        return actions, generated_scores
