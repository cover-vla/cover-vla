    ...
    def step(self, image: np.ndarray, task_description: Optional[str] = None, *args, **kwargs) -> tuple[dict[str, np.ndarray], dict[str, np.ndarray]]:
        ...
        if task_description is not None:
            if task_description != self.task_description:
                ...
                input_ids = self.reset(task_description)
        ...
        norm_raw_actions, action_entropy, language_embedding = self.model.sample_actions(
            input_observation,
            self.task,
            rng=key,
        )
        ...
        return raw_action, action, language_embedding, action_entropy
