...
class OctoModel:
    ...
    def sample_actions(
        ...
        # calculate action entropy for continous actions 
        # action_entropy = action_head.predict_entropy(
        #     transformer_outputs, train=train, argmax=argmax, sample_shape=(1000,), rng=rng
        # )
        
        action, hidden_states = action_head.predict_action(
            transformer_outputs,
            train=train,
            argmax=argmax,
        ...
        # use hidden_states to calculate action entropy
        # print ("hidden_states", hidden_states.shape)
        
        
        return action, hidden_states, transformer_outputs["task"]
