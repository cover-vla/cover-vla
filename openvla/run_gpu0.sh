...
CUDA_VISIBLE_DEVICES=4 python experiments/robot/libero/run_libero_eval.py \
    ...
    --vla_clip_traj_model_path /home/xilun/vla-clip/clip_verifier/bash/trajectory_checkpoints/spatial_transformer_h10_neg2_padded_final_best.pt \
    --vla_clip_history_length 10 \
    --vla_clip_use_transformer True \
    --lang_transform rephrase
