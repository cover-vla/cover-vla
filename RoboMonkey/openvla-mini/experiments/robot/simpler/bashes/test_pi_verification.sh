...
CUDA_VISIBLE_DEVICES=0 python ../run_simpler_eval_with_openpi_verification.py \
...
CUDA_VISIBLE_DEVICES=2 python ../run_simpler_eval_with_openpi_verification.py \
...
# CUDA_VISIBLE_DEVICES=1 python ../run_simpler_eval_with_openpi_verification.py \
#     --task_suite_name simpler_ood \
#     --lang_transform_type rephrase \
#     --pretrained_checkpoint juexzz/INTACT-pi0-finetune-bridge \
#     --num_trials_per_task 150 \
