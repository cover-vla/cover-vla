            ...
            while t < max_steps + cfg.num_steps_wait:
                ...
                if vla_clip_scorer:
                    ...
                    if cfg.use_original_task_description:
                        ...
                        # Map each action back to its corresponding instruction
                        # instructions = []
                        # for i in range(len(predicted_actions)):
                        #     instruction_idx = i // repeated_samples
                        #     instructions.append(candidate_instructions[instruction_idx])
                    ...
                    if cfg.clip_select_action_num_candidates > 1:
                        if cfg.clip_select_action_strategy == "highest_score":
                            ...
                            if len(valid_indices) == 0:
                                ...
                                instruction_idx = best_candidate_idx // (repeated_samples + 5)
                                ...
                                #     print(f"  [t={t}] Selected alternative action via: '{candidate_instructions[instruction_idx]}' (Score: {current_vla_clip_score:.3f})")
                                # else:
