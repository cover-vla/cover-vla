...
REPHRASES_JSON_PATH = '/home/xilun/vla-clip/openvla/experiments/robot/libero/libero_rephrases.json'
VLA_CLIP_MODEL_PATH = '/home/xilun/vla-clip/clip_verifier/trajectory_checkpoints/vla_bert_dino_traj_h8_transformer_final_best.pt'
HISTORY_LENGTH = 8
SCORE_THRESHOLD = 0.3
...
def eval_libero(args: Args) -> None:
    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        candidate_instructions = [task_description] + rephrased_list
