...
class LangTransform:
    ...
    def get_api_key(self):
        with open('./examples/libero/api_keys.txt', 'r') as file:
            file_contents = file.readlines()
            return file_contents[0].strip()
        
    def get_system_prompt(self, transform_type):
        with open(f'./examples/libero/system_prompts/{transform_type}.txt', 'r', encoding='utf-8') as file:
            return file.read()
        
    def get_set_of_words(self, path_to_ep_stat = './examples/libero/unique_words.json'):
