...
class Pi0FAST(_model.BaseModel):
    ...
    ) -> tuple[at.Float[at.Array, "b s emb"], at.Bool[at.Array, "b s"], at.Int[at.Array, "b s"], int]:
        input_mask = []
        ar_mask = []
        token_embeddings = []
        # embed images
    ...
    def compute_loss(
        ...
        input_token_embeddings, input_mask, ar_mask, _ = self.embed_inputs(observation)
    ...
    def sample_actions(
        ...
        *,
        ...
        prefix_token_embeddings, prefix_mask, prefix_ar_mask, _ = self.embed_inputs(observation)
